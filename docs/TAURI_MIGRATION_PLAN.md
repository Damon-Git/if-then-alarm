...
设置数据当前包含计时模式和窗口置顶开关。旧设置如果没有窗口置顶字段，会自动补为 `false`。
...
- `src-tauri/capabilities/default.json`：为主窗口启用默认核心权限、窗口关闭/收起权限、窗口置顶权限、通知权限和文件对话框权限，后续能力按功能逐项添加。
