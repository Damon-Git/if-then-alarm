...
const ReviewPanel = ({ intentSets, timerMode, onSave, onRequestAbandon }: ReviewPanelProps) => {
  ...
  const reviewErrorId = "review-text-error";
  ...
  return (
    <section className="panel review-panel" aria-labelledby="review-title">
      <div className="section-heading">
        ...
        <button className="ghost-button review-abandon-button" type="button" onClick={onRequestAbandon}>
          放弃本轮
        </button>
      </div>
      ...
      <div className="review-layout">
        <form className="review-form" onSubmit={saveReview}>
          ...
          <label className="field review-main-field">
            <span>一句复盘</span>
            <textarea
              aria-describedby={error ? reviewErrorId : undefined}
            ...
            />
            {error ? (
              <p className="error-text" id={reviewErrorId}>
                {error}
              </p>
            ) : null}
          </label>
